...
const CONFIG = {
   ...
   */
  DESTINATION_FOLDER_ID: '1ZrOCfr2P0KuWfWdTFTIy0Puaojzz09vy',
  
  // Nomi dei file "Adesioni" (Destinazione)
  ADESIONI_PRIMARIE_FILENAME: 'Adesione a "Un giorno all\'università" 25-26  - PRIMARIE (Risposte)',
  ADESIONI_SECONDARIE_FILENAME: 'Adesione a "Un giorno all\'università" 25-26  - SECONDO GRADO (Risposte)',
   ...
   */
  REPOPULATE_SOURCE_FILE_PRIMARY: 'Adesione a "Un giorno all\'università" 25-26  - PRIMARIE (Risposte)',
  
  /**
   * Nome del file sorgente per il ripopolamento delle SECONDARIE.
   */
  REPOPULATE_SOURCE_FILE_SECONDARY: 'Adesione a "Un giorno all\'università" 25-26  - SECONDO GRADO (Risposte)',
